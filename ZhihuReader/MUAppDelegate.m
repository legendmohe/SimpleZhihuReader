...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[MUZhihuService shareService] requestForResponseStringWithZhihuURL:[NSURL URLWithString:testURLString]
                                                              withBlock:^(id jsonObject, NSURL *aURL, NSError *error) {
                                                                  ...
                                                                  NSArray* resultArray = [[MUZhihuService shareService] saveJSONObjectToCoreDataAndRetriveAnswers:jsonObject];
                                                                  NSLog(@"result:/n%@", resultArray);
                                                                  
                                                              } progressBlock:nil cancelBlock:nil];
...
- (void)applicationWillTerminate:(UIApplication *)application
{
    ...
    [[MUZhihuService shareService] saveContext];
}
